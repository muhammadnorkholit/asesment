...
@section('main')
    ...
    <div class="d-flex">
        <a href="/admin/pengajar/create" class=" btn btn-main-color mb-3 ms-auto"><i class="fa-solid fa-user-plus"></i> Add</a>
    </div>
    ...
    <table id="table" class="table table-striped" style="width:100%">
        <thead>
            <tr class=" bg-main-color text-white">
                ...
                <th class=" ps-2">Mapel Keahlian</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width:100px" class=" text-capitalize"> <a href="/admin/pengajar/{{$codeGuru->id}}/edit" class=" btn  btn-success"><i class="fa fa-edit"></i> Edit</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
